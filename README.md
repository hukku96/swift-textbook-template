...
この教科書は、iOSプログラミングIIの授業を通じて、自分自身の手で作り上げるSwiftプログラミングの教科書です。

毎回の授業で教員から渡される模範コードを題材に、「このコードはなぜこう書かれているのか」を自分の言葉で説明することで、コードを深く理解することを目的としています。
...
| 章 | テーマ | ファイル | 状態 |
|---|--------|---------|------|
| 第1章 | WebAPIの基本 | [chapters/01-webapi.md](chapters/01-webapi.md) | 未着手 |
